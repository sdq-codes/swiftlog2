        ...
        >
          ...
          <div v-if="step === 1">
            <div  v-for="(ticket, index) in tickets" :key="ticket.id">
              <div v-if="ticket" class="flex bg-gray-100 mb-4 p-2 rounded-b">
                <h6  class="mr-auto font-normal">{{index}}</h6> <input type="radio" :value="index" class="ml-auto" v-model="choosenTicket">
              </div>
            </div>
